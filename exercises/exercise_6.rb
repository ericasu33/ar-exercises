...
@store1.employees.create(first_name: "Kent", last_name: "Smith", hourly_rate: 40)

@store2.employees.create(first_name: "Kate", last_name: "Smith", hourly_rate: 40)
@store2.employees.create(first_name: "Cat", last_name: "Smith", hourly_rate: 80)
@store2.employees.create(first_name: "Apple", last_name: "Smith", hourly_rate: 90)
@store2.employees.create(first_name: "Adrea", last_name: "Smith", hourly_rate: 50)
@store2.employees.create(first_name: "Anita", last_name: "Smith", hourly_rate: 70)